##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.13.0-B3] date: [Sat May 21 14:53:38 JST 2022] 
##########################################################################################################################
...
#-D__weak=__attribute__((weak)) \#-D__weak=__attribute__((weak)) \#-D__weak=__attribute__((weak)) \#-D__weak=__attribute__((weak)) \#-D__packed=__attribute__((__packed__))
...
-ICore/Inc/hardware \
# $(wildcard -ICore/Inc/hardware/*.h) \

# C++ includes
CPP_INCLUDES = $(C_INCLUDES)
CPP_INCLUDES += \
-include stdint.h \
# $(wildcard -ICore/Inc/*.hpp) \
# $(wildcard -ICore/Inc/hardware/*.hpp) \
